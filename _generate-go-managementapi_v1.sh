...
mkdir -p gopkg/model/generated/management_v1
oapi-codegen -config go-helper/generator1/generate-go-managementapiv1.config.yaml src/main/openapi/management-api-v1.yaml

// Package kt_pubapi_gen_queryv3 provides primitives to interact with the openapi HTTP API.
//
...
type EventCountersHeaderClass struct {
	...
	CounterColumns *[]string `json:"counterColumns,omitempty" yaml:"counterColumns,omitempty"`
	...
	//  * visitSourceType
	//  * visitSourceName
	KeyColumns *[]string `json:"keyColumns,omitempty" yaml:"keyColumns,omitempty"`
}
...
type GetIdMappingsResponseClass struct {
	...
	// DataToTimestamp This response contains data until this UNIX timestamp in UTC (seconds since Epoch)
	DataToTimestamp int32                 `json:"dataToTimestamp" yaml:"dataToTimestamp"`
	EventTypes      *[]MappingRecordClass `json:"eventTypes" yaml:"eventTypes"`
	...
	// RequestedToTimestamp In the request you requested data until this UNIX timestamp in UTC (seconds since Epoch)
	RequestedToTimestamp int32                 `json:"requestedToTimestamp" yaml:"requestedToTimestamp"`
	SecondaryTags        *[]MappingRecordClass `json:"secondaryTags" yaml:"secondaryTags"`
	TileGroupPaths       *[]MappingRecordClass `json:"tileGroupPaths" yaml:"tileGroupPaths"`
...
type KeyColumnsIntIdMappingsClass struct {
	...
	Campaign *IntIdToStrMappingClass `json:"campaign" yaml:"campaign"`
	...
	CampaignContent *IntIdToStrMappingClass `json:"campaignContent" yaml:"campaignContent"`
	...
	CampaignMedium *IntIdToStrMappingClass `json:"campaignMedium" yaml:"campaignMedium"`
	...
	EventSourceName *IntIdToStrMappingClass `json:"eventSourceName" yaml:"eventSourceName"`
	...
	EventSourceType *IntIdToStrMappingClass `json:"eventSourceType" yaml:"eventSourceType"`
	...
	EventType *IntIdToStrMappingClass `json:"eventType" yaml:"eventType"`
	...
	PrimaryTags *IntIdToStrMappingClass `json:"primaryTags" yaml:"primaryTags"`
	...
	SecondaryTags *IntIdToStrMappingClass `json:"secondaryTags" yaml:"secondaryTags"`
	...
	TileGroupPath *IntIdToStrMappingClass `json:"tileGroupPath" yaml:"tileGroupPath"`
	...
	TileLanguage *IntIdToStrMappingClass `json:"tileLanguage" yaml:"tileLanguage"`
	...
	TileType *IntIdToStrMappingClass `json:"tileType" yaml:"tileType"`
	...
	Time *map[string]TimeIntervalClass `json:"time" yaml:"time"`
	...
	TrafficSourceName *IntIdToStrMappingClass `json:"trafficSourceName" yaml:"trafficSourceName"`
	...
	TrafficSourceType *IntIdToStrMappingClass `json:"trafficSourceType" yaml:"trafficSourceType"`
	...
	UserAgentType *IntIdToStrMappingClass `json:"userAgentType" yaml:"userAgentType"`
	...
	VisitSourceName *IntIdToStrMappingClass `json:"visitSourceName" yaml:"visitSourceName"`
	...
	VisitSourceType *IntIdToStrMappingClass `json:"visitSourceType" yaml:"visitSourceType"`
	...
	VisitorType *IntIdToStrMappingClass `json:"visitorType" yaml:"visitorType"`
}

// MappingRecordClass defines model for MappingRecordClass.
type MappingRecordClass struct {
	FirstSeenTs *int `json:"firstSeenTs" yaml:"firstSeenTs"`
	IntId       *int `json:"intId,omitempty" yaml:"intId,omitempty"`
	LastSeenTs  *int `json:"lastSeenTs" yaml:"lastSeenTs"`

	// Meta Extra meta-data (str -> str) of the mapping - might be optionally present.
...
type SystemClockResponseClass struct {
	...
	ServerTime *int32 `json:"serverTime,omitempty" yaml:"serverTime,omitempty"`
}

// TileClass defines model for TileClass.
type TileClass struct {
	CounterRows *[][]int64 `json:"counterRows,omitempty" yaml:"counterRows,omitempty"`
	...
	FirstSeen *int32 `json:"firstSeen" yaml:"firstSeen"`
	...
	//
	// note: this info you just get if you have NOT executed the request with `?includeTileDetails=false`!
	TileGroupPaths *map[string]TileGroupPathClass `json:"tileGroupPaths" yaml:"tileGroupPaths"`
...
// IncludeNotTileEventTypesAsWell defines model for includeNotTileEventTypesAsWell.
type IncludeNotTileEventTypesAsWell = string
...
type GetV2StatWebhitsContainerIdEventcountsParams struct {
	...
	Interest *Interest `form:"interest,omitempty" json:"interest,omitempty" yaml:"interest,omitempty"`
	...
	GroupBy *GroupBy `form:"groupBy,omitempty" json:"groupBy,omitempty" yaml:"groupBy,omitempty"`
	...
	EventTypesOnly *EventTypesOnly `form:"eventTypesOnly,omitempty" json:"eventTypesOnly,omitempty" yaml:"eventTypesOnly,omitempty"`
	...
	TileTypesOnly *TileTypesOnly `form:"tileTypesOnly,omitempty" json:"tileTypesOnly,omitempty" yaml:"tileTypesOnly,omitempty"`
	...
	//  * The name of the type ('frontpage', 'page', 'article', ...), or
	//  * The numeric ID of the tile type - returned by `/v2/stat/webhits/{containerId}/idmappings` endpoint - using the format `id:<numeric ID>`, e.g. **"id:123"**
	TileTypeIsNot *TileTypeIsNot `form:"tileTypeIsNot,omitempty" json:"tileTypeIsNot,omitempty" yaml:"tileTypeIsNot,omitempty"`
	...
	// UserAgentTypeIsNot Data filter option. Comma separated list of *userAgentType*s you want the query to be excluded from. If you list more values here then they are interpreted with an OR operator.
	//
	...
	VisitorTypesOnly *VisitorTypesOnly `form:"visitorTypesOnly,omitempty" json:"visitorTypesOnly,omitempty" yaml:"visitorTypesOnly,omitempty"`
	...
	TileLanguagesOnly *TileLanguagesOnly `form:"tileLanguagesOnly,omitempty" json:"tileLanguagesOnly,omitempty" yaml:"tileLanguagesOnly,omitempty"`
	...
	PrimaryTagsOnly *PrimaryTagsOnly `form:"primaryTagsOnly,omitempty" json:"primaryTagsOnly,omitempty" yaml:"primaryTagsOnly,omitempty"`
	...
	SecondaryTagsOnly *SecondaryTagsOnly `form:"secondaryTagsOnly,omitempty" json:"secondaryTagsOnly,omitempty" yaml:"secondaryTagsOnly,omitempty"`
	...
	EventSourceTypesOnly *EventSourceTypesOnly `form:"eventSourceTypesOnly,omitempty" json:"eventSourceTypesOnly,omitempty" yaml:"eventSourceTypesOnly,omitempty"`
	...
	TrafficSourceTypesOnly *TrafficSourceTypesOnly `form:"trafficSourceTypesOnly,omitempty" json:"trafficSourceTypesOnly,omitempty" yaml:"trafficSourceTypesOnly,omitempty"`
	...
	TrafficSourceNamesOnly *TrafficSourceNamesOnly `form:"trafficSourceNamesOnly,omitempty" json:"trafficSourceNamesOnly,omitempty" yaml:"trafficSourceNamesOnly,omitempty"`
	...
	CampaignsOnly *CampaignsOnly `form:"campaignsOnly,omitempty" json:"campaignsOnly,omitempty" yaml:"campaignsOnly,omitempty"`
	...
	//
	// Campaign tracking in Keytiles works based on Urchin Tracking Module (UTM) parameters specification. For more info visit: [Wikipedia - UTM parameters](https://en.wikipedia.org/wiki/UTM_parameters)
	CampaignMediumsOnly *CampaignMediumsOnly `form:"campaignMediumsOnly,omitempty" json:"campaignMediumsOnly,omitempty" yaml:"campaignMediumsOnly,omitempty"`
	...
	// QueryTuning Controls what Keytiles may change when your timestamps or time grouping do not line up with neat chart boundaries.
	//
	...
	// ClientTimezone Optional hint: the timezone your **users** think in when they picked dates (browser locale, report settings). You still send UTC unix seconds (or `now-…`); this tells Keytiles how to interpret “start of day” when smoothing a chart.
	//
	// **Default:** omitted.
	//
...
type GetV2StatWebhitsContainerIdEventcountsTilesParams struct {
	...
	IncludeTileDetails *IncludeTileDetails `form:"includeTileDetails,omitempty" json:"includeTileDetails,omitempty" yaml:"includeTileDetails,omitempty"`
	...
	Threshold *Threshold `form:"threshold,omitempty" json:"threshold,omitempty" yaml:"threshold,omitempty"`

	// SortBy When you use `limit` or `threshold` parameters you can optionally define which Counter column should be used to order the records so term like 'top 100 Tiles' becomes well defined. Sorts the tiles in desc order based on the returned event counter field you specify here.
	//
	...
	TileIdsOnly *TileIdsOnly `form:"tileIdsOnly,omitempty" json:"tileIdsOnly,omitempty" yaml:"tileIdsOnly,omitempty"`
...
type GetV2StatWebhitsContainerIdIdmappingsParams struct {
	...
	//  * primaryTag
	//  * secondaryTag
	MappingTypes MappingTypes `form:"mappingTypes" json:"mappingTypes" yaml:"mappingTypes"`
	...
	IncludeFirstLastSeenTs *IncludeFirstLastSeenTs `form:"includeFirstLastSeenTs,omitempty" json:"includeFirstLastSeenTs,omitempty" yaml:"includeFirstLastSeenTs,omitempty"`

	// IncludeNotTileEventTypesAsWell This is a boolean parameter so you can send `true` or `false` here as a value. By default the value is `false`.
	//
	...
	IncludeNotTileEventTypesAsWell *IncludeNotTileEventTypesAsWell `form:"includeNotTileEventTypesAsWell,omitempty" json:"includeNotTileEventTypesAsWell,omitempty" yaml:"includeNotTileEventTypesAsWell,omitempty"`
}

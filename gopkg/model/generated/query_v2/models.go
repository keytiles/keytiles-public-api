...
type EventCountersResponseClass struct {
	...
	Problems *[]StatApiEndpointProblemClass `json:"problems" yaml:"problems"`
...
type GetIdMappingsResponseClass struct {
	...
	// Problems List of errors/warnings
	Problems *[]externalRef0.ProblemBaseClass `json:"problems" yaml:"problems"`
...
type StatApiEndpointProblemClass struct {
	ErrorCodes *[]StatApiEndpointErrorCodes `json:"errorCodes" yaml:"errorCodes"`
	...
	Place *externalRef0.ProblemPlaceEnum `json:"place" yaml:"place"`
	...
	Severity  StatApiEndpointProblemClassSeverity `json:"severity" yaml:"severity"`
}

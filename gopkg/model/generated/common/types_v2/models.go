...
type BaseResponseClass struct {
	...
	Problems *[]ProblemBaseClass `json:"problems"`
...
type ContainerQueryRangeResponseClass struct {
	Container *ResponseContainerInfoClass `json:"container"`
...
type ProblemBaseClass struct {
	ErrorCodes *[]CommonErrorCodes `json:"errorCodes"`
	...
	Place *ProblemPlaceEnum `json:"place"`
	...
	Severity  ProblemBaseClassSeverity `json:"severity"`
}

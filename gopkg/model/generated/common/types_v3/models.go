...
// Defines values for ProblemClassSeverity.
const (
	Error   ProblemClassSeverity = "error"
	Warning ProblemClassSeverity = "warning"
)
...
type BaseResponseClass struct {
	...
	Problems *[]ProblemClass `json:"problems" yaml:"problems"`
...
// ProblemClass defines model for ProblemClass.
type ProblemClass struct {
	...
	Severity  ProblemClassSeverity `json:"severity" yaml:"severity"`
}

// ProblemClassSeverity defines model for ProblemClass.Severity.
type ProblemClassSeverity string

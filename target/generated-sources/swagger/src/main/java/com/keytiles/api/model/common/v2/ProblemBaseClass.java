...
public class ProblemBaseClass implements Serializable{
  ...
  public List<CommonErrorCodes> errorCodes = new ArrayList<>();

  
  // @Generator: arg 'severity': mandatory field 
  // @Generator: arg 'message': mandatory field 
  @JsonCreator
  public ProblemBaseClass(@JsonProperty("severity") SeverityEnum severity, @JsonProperty("message") String message) {
    super();
    if(severity == null) {
  ...
  public ProblemBaseClass addErrorCodesItem(CommonErrorCodes errorCodesItem) {
  ...
  public ProblemBaseClass removeErrorCodesItem(CommonErrorCodes errorCodesItem) {
    if (this.errorCodes != null) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProblemBaseClass problemBaseClass = (ProblemBaseClass) o;
    return Objects.equals(this.severity, problemBaseClass.severity) &&
        Objects.equals(this.message, problemBaseClass.message) &&
        Objects.equals(this.place, problemBaseClass.place) &&
        Objects.equals(this.placeName, problemBaseClass.placeName) &&
        Objects.equals(this.errorCodes, problemBaseClass.errorCodes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProblemBaseClass {\n");

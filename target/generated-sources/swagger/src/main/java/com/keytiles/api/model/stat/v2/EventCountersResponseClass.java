...
import com.keytiles.api.model.stat.v2.EventCountersHeaderClass;
import com.keytiles.api.model.stat.v2.KeyColumnsIntIdMappingsClass;
...
public class EventCountersResponseClass extends ContainerQueryRangeResponseClass implements Serializable{
  ...
  private EventCountersHeaderClass resultColumns = null;
  ...
  // @Generator: becomes private - as non-nullable so we need to protect it with setter and null-check 
  private List<List<Long>> aggregatedCounterRows = new ArrayList<>();
  ...
  // @Generator: field refers to 'KeyColumnsIntIdMappingsClass' which is 'nullable=true' so this is inherited into this field 
  // @Generator: becomes public - as nullable (no need to null-check) and not readonly 
  @JsonProperty("keyColumnsMappings")
  ...
  public EventCountersHeaderClass getResultColumns() {
    return resultColumns;
  }  

  // @Generator: added to protect field 'resultColumns' against null-value assignment 
  @JsonProperty("resultColumns")
  public void setResultColumns(EventCountersHeaderClass resultColumns) {
    if(resultColumns == null) {
      throw new IllegalArgumentException("'resultColumns' value can not be NULL");
    }
    this.resultColumns = resultColumns;
  ...
  @JsonProperty("aggregatedCounterRows")
  public List<List<Long>> getAggregatedCounterRows() {
    return aggregatedCounterRows;
  }  

  // @Generator: added to protect field 'aggregatedCounterRows' against null-value assignment 
  @JsonProperty("aggregatedCounterRows")
  public void setAggregatedCounterRows(List<List<Long>> aggregatedCounterRows) {
    if(aggregatedCounterRows == null) {
      throw new IllegalArgumentException("'aggregatedCounterRows' value can not be NULL");
    }
    this.aggregatedCounterRows = aggregatedCounterRows;
  }



  // @Generator: builder style helper method to add values to not-readonly array field
  public EventCountersResponseClass addProblemsItem(StatApiEndpointProblemClass problemsItem) {
  ...
  public EventCountersResponseClass removeProblemsItem(StatApiEndpointProblemClass problemsItem) {
    if (this.problems != null) {
  ...
  // @Generator: builder style helper method to add values to not-readonly array field
  public EventCountersResponseClass addAggregatedCounterRowsItem(List<Long> aggregatedCounterRowsItem) {
    if (this.aggregatedCounterRows == null) {
 		this.aggregatedCounterRows = new ArrayList<>();
    }
    this.aggregatedCounterRows.add(aggregatedCounterRowsItem);
    return this;
  }

  // @Generator: builder style helper method to remove values from not-readonly array field
  public EventCountersResponseClass removeAggregatedCounterRowsItem(List<Long> aggregatedCounterRowsItem) {
    if (this.aggregatedCounterRows != null) {
    	this.aggregatedCounterRows.remove(aggregatedCounterRowsItem);
    }
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EventCountersResponseClass eventCountersResponseClass = (EventCountersResponseClass) o;
    return Objects.equals(this.problems, eventCountersResponseClass.problems) &&
        Objects.equals(this.keyColumnsMappings, eventCountersResponseClass.keyColumnsMappings) &&
        Objects.equals(this.resultColumns, eventCountersResponseClass.resultColumns) &&
        Objects.equals(this.aggregatedCounterRows, eventCountersResponseClass.aggregatedCounterRows) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(problems, keyColumnsMappings, resultColumns, aggregatedCounterRows, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class EventCountersResponseClass {\n");
    sb.append("    ").append(toIndentedString(super.toString())).append("\n");
    sb.append("    problems: ").append(toIndentedString(problems)).append("\n");
    sb.append("    keyColumnsMappings: ").append(toIndentedString(keyColumnsMappings)).append("\n");
    sb.append("    resultColumns: ").append(toIndentedString(resultColumns)).append("\n");
    sb.append("    aggregatedCounterRows: ").append(toIndentedString(aggregatedCounterRows)).append("\n");
    sb.append("}");
    return sb.toString();
  }

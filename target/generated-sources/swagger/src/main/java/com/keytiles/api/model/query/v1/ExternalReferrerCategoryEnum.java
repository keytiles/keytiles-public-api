...
/**
 * Possible values for external referrer category
 *
 */
public enum ExternalReferrerCategoryEnum {
  SEARCH("search"),
  SOCIAL("social"),
  LINK("link");
  ...
  ExternalReferrerCategoryEnum(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ExternalReferrerCategoryEnum fromValue(String input) {
    for (ExternalReferrerCategoryEnum b : ExternalReferrerCategoryEnum.values()) {

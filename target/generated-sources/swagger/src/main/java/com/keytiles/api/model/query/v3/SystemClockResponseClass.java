...
public class SystemClockResponseClass implements Serializable{
  ...
  public SystemClockResponseClass(@JsonProperty("serverTime") Integer serverTime) {
    super();
    if(serverTime == null) {
      throw new IllegalArgumentException("'serverTime' value can not be NULL");
    }
  ...
  // @Generator: added to protect field 'serverTime' against null-value assignment 
  @JsonProperty("serverTime")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SystemClockResponseClass systemClockResponseClass = (SystemClockResponseClass) o;
    return Objects.equals(this.serverTime, systemClockResponseClass.serverTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class SystemClockResponseClass {\n");

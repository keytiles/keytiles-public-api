...
/**
 * Gets or Sets StatApiEndpointLocalErrorCodes
 *
 */
public enum StatApiEndpointLocalErrorCodes {
  ...
  StatApiEndpointLocalErrorCodes(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static StatApiEndpointLocalErrorCodes fromValue(String input) {
    for (StatApiEndpointLocalErrorCodes b : StatApiEndpointLocalErrorCodes.values()) {

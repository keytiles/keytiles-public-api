...
public class BaseResponseClass implements Serializable{
  ...
  // @Generator: added to protect field 'processingTookMillis' against null-value assignment 
  @JsonProperty("processingTookMillis")
  ...
  // @Generator: added to protect field 'messages' against null-value assignment 
  @JsonProperty("messages")

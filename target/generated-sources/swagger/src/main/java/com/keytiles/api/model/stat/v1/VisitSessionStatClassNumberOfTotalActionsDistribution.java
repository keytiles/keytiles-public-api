...
public class VisitSessionStatClassNumberOfTotalActionsDistribution implements Serializable{
  private static final long serialVersionUID = 1L;


  // @Generator: becomes private - as non-nullable so we need to protect it with setter and null-check 
  private Integer numOfActions = null;
  ...
  public VisitSessionStatClassNumberOfTotalActionsDistribution(@JsonProperty("numOfActions") Integer numOfActions, @JsonProperty("visitSessionCount") Long visitSessionCount) {
    super();
    if(numOfActions == null) {
      throw new IllegalArgumentException("'numOfActions' value can not be NULL");
    }
  ...
  @JsonProperty("numOfActions")
  public Integer getNumOfActions() {
    return numOfActions;
  }  

  // @Generator: added to protect field 'numOfActions' against null-value assignment 
  @JsonProperty("numOfActions")
  public void setNumOfActions(Integer numOfActions) {
    if(numOfActions == null) {
      throw new IllegalArgumentException("'numOfActions' value can not be NULL");
    }
    this.numOfActions = numOfActions;
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VisitSessionStatClassNumberOfTotalActionsDistribution visitSessionStatClassNumberOfTotalActionsDistribution = (VisitSessionStatClassNumberOfTotalActionsDistribution) o;
    return Objects.equals(this.numOfActions, visitSessionStatClassNumberOfTotalActionsDistribution.numOfActions) &&
        Objects.equals(this.visitSessionCount, visitSessionStatClassNumberOfTotalActionsDistribution.visitSessionCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(numOfActions, visitSessionCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class VisitSessionStatClassNumberOfTotalActionsDistribution {\n");
    
    sb.append("    numOfActions: ").append(toIndentedString(numOfActions)).append("\n");

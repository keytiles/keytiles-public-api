...
public class ReportSetup implements Serializable{
  ...
  // @Generator: arg 'webhookUrl': non-nullable and does not have default value - we must enforce a non-null initial value 
  // @Generator: arg 'webhookAuthHeader': non-nullable and does not have default value - we must enforce a non-null initial value 
  // @Generator: arg 'resourceVersion': mandatory field 
  @JsonCreator
  public ReportSetup(@JsonProperty("id") String id, @JsonProperty("metaData") MetaData metaData, @JsonProperty("createdAt") Integer createdAt, @JsonProperty("isDisabled") Boolean isDisabled, @JsonProperty("webhookUrl") String webhookUrl, @JsonProperty("webhookAuthHeader") String webhookAuthHeader, @JsonProperty("resourceVersion") Integer resourceVersion) {
    super();
    if(id == null) {
    ...
    if(webhookUrl == null) {
      throw new IllegalArgumentException("'webhookUrl' value can not be NULL");
    }
    if(webhookAuthHeader == null) {
      throw new IllegalArgumentException("'webhookAuthHeader' value can not be NULL");
    }
  ...
  // @Generator: added to protect field 'webhookUrl' against null-value assignment 
  @JsonProperty("webhookUrl")
  ...
  @JsonProperty("webhookAuthHeader")
  public String getWebhookAuthHeader() {
    return webhookAuthHeader;
  }  

  // @Generator: added to protect field 'webhookAuthHeader' against null-value assignment 
  @JsonProperty("webhookAuthHeader")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, reportSetup.id) &&
        ...
        Objects.equals(this.webhookUrl, reportSetup.webhookUrl) &&
        Objects.equals(this.webhookAuthHeader, reportSetup.webhookAuthHeader) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, metaData, createdAt, isDisabled, schedule, recipients, webhookUrl, webhookAuthHeader, queries, resourceVersion);
  }

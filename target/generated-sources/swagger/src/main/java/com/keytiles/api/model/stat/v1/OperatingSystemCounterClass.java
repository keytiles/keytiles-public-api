...
public class OperatingSystemCounterClass implements Serializable{
  private static final long serialVersionUID = 1L;


  // @Generator: becomes private - as non-nullable so we need to protect it with setter and null-check 
  private String opSystemType = null;
  ...
  // @Generator: arg 'opSystemType': non-nullable and does not have default value - we must enforce a non-null initial value 
  // @Generator: arg 'count': non-nullable and does not have default value - we must enforce a non-null initial value 
  @JsonCreator
  public OperatingSystemCounterClass(@JsonProperty("opSystemType") String opSystemType, @JsonProperty("count") Long count) {
    super();
    if(opSystemType == null) {
      throw new IllegalArgumentException("'opSystemType' value can not be NULL");
    }
    if(count == null) {
      throw new IllegalArgumentException("'count' value can not be NULL");
    }
  ...
  @JsonProperty("opSystemType")
  public String getOpSystemType() {
    return opSystemType;
  }  

  // @Generator: added to protect field 'opSystemType' against null-value assignment 
  @JsonProperty("opSystemType")
  ...
  // @Generator: added to protect field 'count' against null-value assignment 
  @JsonProperty("count")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OperatingSystemCounterClass operatingSystemCounterClass = (OperatingSystemCounterClass) o;
    return Objects.equals(this.opSystemType, operatingSystemCounterClass.opSystemType) &&
        Objects.equals(this.count, operatingSystemCounterClass.count);
  }

  @Override
  public int hashCode() {
    return Objects.hash(opSystemType, count);
  }
  ...
  public String toString() {
    ...
    sb.append("class OperatingSystemCounterClass {\n");
    
    sb.append("    opSystemType: ").append(toIndentedString(opSystemType)).append("\n");

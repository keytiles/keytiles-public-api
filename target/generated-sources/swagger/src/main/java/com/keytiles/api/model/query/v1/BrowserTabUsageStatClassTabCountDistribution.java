...
public class BrowserTabUsageStatClassTabCountDistribution implements Serializable{
  private static final long serialVersionUID = 1L;


  // @Generator: becomes private - as non-nullable so we need to protect it with setter and null-check 
  private Integer openTabCount = null;
  ...
  public BrowserTabUsageStatClassTabCountDistribution(@JsonProperty("openTabCount") Integer openTabCount, @JsonProperty("visitSessionCount") Long visitSessionCount) {
    super();
    if(openTabCount == null) {
      throw new IllegalArgumentException("'openTabCount' value can not be NULL");
    }
  ...
  @JsonProperty("openTabCount")
  public Integer getOpenTabCount() {
    return openTabCount;
  }  

  // @Generator: added to protect field 'openTabCount' against null-value assignment 
  @JsonProperty("openTabCount")
  public void setOpenTabCount(Integer openTabCount) {
    if(openTabCount == null) {
      throw new IllegalArgumentException("'openTabCount' value can not be NULL");
    }
    this.openTabCount = openTabCount;
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BrowserTabUsageStatClassTabCountDistribution browserTabUsageStatClassTabCountDistribution = (BrowserTabUsageStatClassTabCountDistribution) o;
    return Objects.equals(this.openTabCount, browserTabUsageStatClassTabCountDistribution.openTabCount) &&
        Objects.equals(this.visitSessionCount, browserTabUsageStatClassTabCountDistribution.visitSessionCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(openTabCount, visitSessionCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class BrowserTabUsageStatClassTabCountDistribution {\n");
    
    sb.append("    openTabCount: ").append(toIndentedString(openTabCount)).append("\n");

...
import com.keytiles.api.model.query.v3.TimeIntervalClass;
...
public class TimeColumnIntIdToIntervalMappingClass implements Serializable{
  ...
  @JsonProperty("time")
  public Map<String, TimeIntervalClass> time = null;
  ...
  public TimeColumnIntIdToIntervalMappingClass putTimeItem(String key, TimeIntervalClass timeItem) {
    if (this.time == null) {
		this.time = new HashMap<>();
    }
    this.time.put(key, timeItem);
    return this;
  }

  // @Generator: builder style helper method to remove values from not-readonly map field
  public TimeColumnIntIdToIntervalMappingClass removeTimeItem(String key) {
    if (this.time != null) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TimeColumnIntIdToIntervalMappingClass timeColumnIntIdToIntervalMappingClass = (TimeColumnIntIdToIntervalMappingClass) o;
    return Objects.equals(this.time, timeColumnIntIdToIntervalMappingClass.time);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimeColumnIntIdToIntervalMappingClass {\n");

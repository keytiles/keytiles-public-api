...
public class WebClientLocaleCounterClass implements Serializable{
  ...
  // @Generator: arg 'locale': non-nullable and does not have default value - we must enforce a non-null initial value 
  // @Generator: arg 'count': non-nullable and does not have default value - we must enforce a non-null initial value 
  @JsonCreator
  public WebClientLocaleCounterClass(@JsonProperty("locale") String locale, @JsonProperty("count") Long count) {
    super();
    if(locale == null) {
      throw new IllegalArgumentException("'locale' value can not be NULL");
    }
    if(count == null) {
  ...
  // @Generator: added to protect field 'locale' against null-value assignment 
  @JsonProperty("locale")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WebClientLocaleCounterClass webClientLocaleCounterClass = (WebClientLocaleCounterClass) o;
    return Objects.equals(this.locale, webClientLocaleCounterClass.locale) &&
        Objects.equals(this.count, webClientLocaleCounterClass.count);
  }

  @Override
  public int hashCode() {
    return Objects.hash(locale, count);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebClientLocaleCounterClass {\n");

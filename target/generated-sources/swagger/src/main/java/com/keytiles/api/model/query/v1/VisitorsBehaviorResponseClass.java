...
import com.keytiles.api.model.query.v1.BrowserTabUsageStatClass;
import com.keytiles.api.model.query.v1.VisitSessionStatClass;
import java.util.ArrayList;
import java.util.List;

import java.io.Serializable;

public class VisitorsBehaviorResponseClass extends IntervalBasedResponseClass implements Serializable{
  ...
  private List<BrowserTabUsageStatClass> browserTabs = new ArrayList<>();

  // @Generator: non-nullable property so Codegen applied a default empty array to it automatically because it is possible with this type 
  // @Generator: becomes private - as non-nullable so we need to protect it with setter and null-check 
  private List<VisitSessionStatClass> visitSessions = new ArrayList<>();


  
  @JsonCreator
  public VisitorsBehaviorResponseClass(@JsonProperty("requestReceivedAt") Integer requestReceivedAt, @JsonProperty("processingTookMillis") Integer processingTookMillis, @JsonProperty("container") ResponseContainerInfoClass container, @JsonProperty("requestedFromTimestamp") Integer requestedFromTimestamp, @JsonProperty("requestedToTimestamp") Integer requestedToTimestamp, @JsonProperty("dataFromTimestamp") Integer dataFromTimestamp, @JsonProperty("dataToTimestamp") Integer dataToTimestamp) {
  ...
  @JsonProperty("browserTabs")
  public List<BrowserTabUsageStatClass> getBrowserTabs() {
    return browserTabs;
  }  

  // @Generator: added to protect field 'browserTabs' against null-value assignment 
  @JsonProperty("browserTabs")
  public void setBrowserTabs(List<BrowserTabUsageStatClass> browserTabs) {
    if(browserTabs == null) {
      throw new IllegalArgumentException("'browserTabs' value can not be NULL");
    }
    this.browserTabs = browserTabs;
  }

  @JsonProperty("visitSessions")
  public List<VisitSessionStatClass> getVisitSessions() {
    return visitSessions;
  }  

  // @Generator: added to protect field 'visitSessions' against null-value assignment 
  @JsonProperty("visitSessions")
  public void setVisitSessions(List<VisitSessionStatClass> visitSessions) {
    if(visitSessions == null) {
      throw new IllegalArgumentException("'visitSessions' value can not be NULL");
    }
  ...
  public VisitorsBehaviorResponseClass addBrowserTabsItem(BrowserTabUsageStatClass browserTabsItem) {
    if (this.browserTabs == null) {
 		this.browserTabs = new ArrayList<>();
    }
    this.browserTabs.add(browserTabsItem);
    return this;
  }

  // @Generator: builder style helper method to remove values from not-readonly array field
  public VisitorsBehaviorResponseClass removeBrowserTabsItem(BrowserTabUsageStatClass browserTabsItem) {
    if (this.browserTabs != null) {
    	this.browserTabs.remove(browserTabsItem);
    }
    return this;
  }

  // @Generator: builder style helper method to add values to not-readonly array field
  public VisitorsBehaviorResponseClass addVisitSessionsItem(VisitSessionStatClass visitSessionsItem) {
    if (this.visitSessions == null) {
 		this.visitSessions = new ArrayList<>();
    }
    this.visitSessions.add(visitSessionsItem);
    return this;
  }

  // @Generator: builder style helper method to remove values from not-readonly array field
  public VisitorsBehaviorResponseClass removeVisitSessionsItem(VisitSessionStatClass visitSessionsItem) {
    if (this.visitSessions != null) {
    	this.visitSessions.remove(visitSessionsItem);
    }
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VisitorsBehaviorResponseClass visitorsBehaviorResponseClass = (VisitorsBehaviorResponseClass) o;
    return Objects.equals(this.browserTabs, visitorsBehaviorResponseClass.browserTabs) &&
        Objects.equals(this.visitSessions, visitorsBehaviorResponseClass.visitSessions) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(browserTabs, visitSessions, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class VisitorsBehaviorResponseClass {\n");
    sb.append("    ").append(toIndentedString(super.toString())).append("\n");
    sb.append("    browserTabs: ").append(toIndentedString(browserTabs)).append("\n");
    sb.append("    visitSessions: ").append(toIndentedString(visitSessions)).append("\n");
    sb.append("}");
    return sb.toString();
  }

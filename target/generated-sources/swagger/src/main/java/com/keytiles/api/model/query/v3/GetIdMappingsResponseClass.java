...
public class GetIdMappingsResponseClass extends ContainerQueryRangeResponseV3Class implements Serializable{
  ...
  // @Generator: this array does not have default and nullable - so let's keep it on NULL then 
  // @Generator: becomes public - as nullable (no need to null-check) and not readonly 
  @JsonProperty("trafficSourceTypes")
  public List<MappingRecordClass> trafficSourceTypes = null;
  ...
  // @Generator: builder style helper method to add values to not-readonly array field
  public GetIdMappingsResponseClass addTrafficSourceTypesItem(MappingRecordClass trafficSourceTypesItem) {
    if (this.trafficSourceTypes == null) {
 		this.trafficSourceTypes = new ArrayList<>();
    }
    this.trafficSourceTypes.add(trafficSourceTypesItem);
    return this;
  }

  // @Generator: builder style helper method to remove values from not-readonly array field
  public GetIdMappingsResponseClass removeTrafficSourceTypesItem(MappingRecordClass trafficSourceTypesItem) {
    if (this.trafficSourceTypes != null) {
    	this.trafficSourceTypes.remove(trafficSourceTypesItem);
    }
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.eventTypes, getIdMappingsResponseClass.eventTypes) &&
        ...
        Objects.equals(this.trafficSourceTypes, getIdMappingsResponseClass.trafficSourceTypes) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eventTypes, visitorTypes, userAgentTypes, tileLanguages, tileTypes, tileGroupPaths, trafficSourceNames, trafficSourceTypes, campaigns, campaignMediums, campaignContents, primaryTags, secondaryTags, super.hashCode());
  }

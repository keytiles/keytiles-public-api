...
public class TileClass implements Serializable{
  ...
  // @Generator: becomes private - as non-nullable so we need to protect it with setter and null-check 
  private List<List<Long>> counterRows = new ArrayList<>();
  ...
  @JsonCreator
  public TileClass(@JsonProperty("type") Integer type) {
    super();
    if(type == null) {
  ...
  @JsonProperty("counterRows")
  public List<List<Long>> getCounterRows() {
    return counterRows;
  }  

  // @Generator: added to protect field 'counterRows' against null-value assignment 
  @JsonProperty("counterRows")
  public void setCounterRows(List<List<Long>> counterRows) {
    if(counterRows == null) {
      throw new IllegalArgumentException("'counterRows' value can not be NULL");
    }
  ...
  public TileClass putTileGroupPathsItem(String key, TileGroupPathClass tileGroupPathsItem) {
  ...
  public TileClass removeTileGroupPathsItem(String key) {
    if (this.tileGroupPaths != null) {
  ...
  public TileClass addCounterRowsItem(List<Long> counterRowsItem) {
    if (this.counterRows == null) {
 		this.counterRows = new ArrayList<>();
    }
    this.counterRows.add(counterRowsItem);
    return this;
  }

  // @Generator: builder style helper method to remove values from not-readonly array field
  public TileClass removeCounterRowsItem(List<Long> counterRowsItem) {
    if (this.counterRows != null) {
    	this.counterRows.remove(counterRowsItem);
    }
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TileClass tileClass = (TileClass) o;
    return Objects.equals(this.type, tileClass.type) &&
        Objects.equals(this.labelsJSON, tileClass.labelsJSON) &&
        Objects.equals(this.firstSeen, tileClass.firstSeen) &&
        Objects.equals(this.lastSeen, tileClass.lastSeen) &&
        Objects.equals(this.tileGroupPaths, tileClass.tileGroupPaths) &&
        Objects.equals(this.counterRows, tileClass.counterRows);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, labelsJSON, firstSeen, lastSeen, tileGroupPaths, counterRows);
  }
  ...
  public String toString() {
    ...
    sb.append("    counterRows: ").append(toIndentedString(counterRows)).append("\n");
    sb.append("}");
    return sb.toString();
  }

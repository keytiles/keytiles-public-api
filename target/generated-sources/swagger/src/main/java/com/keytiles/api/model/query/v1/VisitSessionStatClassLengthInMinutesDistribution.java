...
public class VisitSessionStatClassLengthInMinutesDistribution implements Serializable{
  private static final long serialVersionUID = 1L;


  // @Generator: becomes private - as non-nullable so we need to protect it with setter and null-check 
  private Integer lengthInMin = null;

  // @Generator: becomes private - as non-nullable so we need to protect it with setter and null-check 
  private Long visitSessionCount = null;


  
  // @Generator: arg 'lengthInMin': non-nullable and does not have default value - we must enforce a non-null initial value 
  // @Generator: arg 'visitSessionCount': non-nullable and does not have default value - we must enforce a non-null initial value 
  @JsonCreator
  public VisitSessionStatClassLengthInMinutesDistribution(@JsonProperty("lengthInMin") Integer lengthInMin, @JsonProperty("visitSessionCount") Long visitSessionCount) {
    super();
    if(lengthInMin == null) {
      throw new IllegalArgumentException("'lengthInMin' value can not be NULL");
    }
    if(visitSessionCount == null) {
      throw new IllegalArgumentException("'visitSessionCount' value can not be NULL");
    }
    this.lengthInMin = lengthInMin;
    this.visitSessionCount = visitSessionCount;
  }
  
  
 
  @JsonProperty("lengthInMin")
  public Integer getLengthInMin() {
    return lengthInMin;
  }  

  // @Generator: added to protect field 'lengthInMin' against null-value assignment 
  @JsonProperty("lengthInMin")
  ...
  @JsonProperty("visitSessionCount")
  public Long getVisitSessionCount() {
    return visitSessionCount;
  }  

  // @Generator: added to protect field 'visitSessionCount' against null-value assignment 
  @JsonProperty("visitSessionCount")
  public void setVisitSessionCount(Long visitSessionCount) {
    if(visitSessionCount == null) {
      throw new IllegalArgumentException("'visitSessionCount' value can not be NULL");
    }
    this.visitSessionCount = visitSessionCount;
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VisitSessionStatClassLengthInMinutesDistribution visitSessionStatClassLengthInMinutesDistribution = (VisitSessionStatClassLengthInMinutesDistribution) o;
    return Objects.equals(this.lengthInMin, visitSessionStatClassLengthInMinutesDistribution.lengthInMin) &&
        Objects.equals(this.visitSessionCount, visitSessionStatClassLengthInMinutesDistribution.visitSessionCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(lengthInMin, visitSessionCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class VisitSessionStatClassLengthInMinutesDistribution {\n");
    
    sb.append("    lengthInMin: ").append(toIndentedString(lengthInMin)).append("\n");
    sb.append("    visitSessionCount: ").append(toIndentedString(visitSessionCount)).append("\n");
    sb.append("}");
    return sb.toString();
  }

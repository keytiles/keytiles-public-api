...
/**
 * Possible values for referrer category
 *
 */
public enum ReferrerCategoryEnum {
  DIRECT("direct"),
  SEARCH("search"),
  SOCIAL("social"),
  LINK("link"),
  ...
  ReferrerCategoryEnum(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ReferrerCategoryEnum fromValue(String input) {
    for (ReferrerCategoryEnum b : ReferrerCategoryEnum.values()) {

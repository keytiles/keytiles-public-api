...
public class MappingRecordClass implements Serializable{
  ...
  @JsonProperty("firstSeenTs")
  public Integer firstSeenTs = null;
  ...
  public MappingRecordClass(@JsonProperty("strId") String strId, @JsonProperty("intId") Integer intId) {
    super();
    if(strId == null) {
      throw new IllegalArgumentException("'strId' value can not be NULL");
    }
    if(intId == null) {
      throw new IllegalArgumentException("'intId' value can not be NULL");
    }
    this.strId = strId;
    this.intId = intId;
  }
  ...
  // @Generator: added to protect field 'strId' against null-value assignment 
  @JsonProperty("strId")
  ...
  // @Generator: added to protect field 'intId' against null-value assignment 
  @JsonProperty("intId")
  ...
  public MappingRecordClass putMetaItem(String key, String metaItem) {
    if (this.meta == null) {
  ...
  public MappingRecordClass removeMetaItem(String key) {
    if (this.meta != null) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MappingRecordClass mappingRecordClass = (MappingRecordClass) o;
    return Objects.equals(this.strId, mappingRecordClass.strId) &&
        Objects.equals(this.intId, mappingRecordClass.intId) &&
        Objects.equals(this.firstSeenTs, mappingRecordClass.firstSeenTs) &&
        Objects.equals(this.lastSeenTs, mappingRecordClass.lastSeenTs) &&
        Objects.equals(this.meta, mappingRecordClass.meta);
  }

  @Override
  public int hashCode() {
    return Objects.hash(strId, intId, firstSeenTs, lastSeenTs, meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class MappingRecordClass {\n");
    
    sb.append("    strId: ").append(toIndentedString(strId)).append("\n");
    sb.append("    intId: ").append(toIndentedString(intId)).append("\n");
    sb.append("    firstSeenTs: ").append(toIndentedString(firstSeenTs)).append("\n");
    sb.append("    lastSeenTs: ").append(toIndentedString(lastSeenTs)).append("\n");

...
public class ScreenResolutionCounterClass implements Serializable{
  ...
  public ScreenResolutionCounterClass(@JsonProperty("resolution") String resolution, @JsonProperty("count") Long count) {
    super();
    if(resolution == null) {
      throw new IllegalArgumentException("'resolution' value can not be NULL");
    }
    if(count == null) {
  ...
  // @Generator: added to protect field 'resolution' against null-value assignment 
  @JsonProperty("resolution")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ScreenResolutionCounterClass screenResolutionCounterClass = (ScreenResolutionCounterClass) o;
    return Objects.equals(this.resolution, screenResolutionCounterClass.resolution) &&
        Objects.equals(this.count, screenResolutionCounterClass.count);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resolution, count);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScreenResolutionCounterClass {\n");

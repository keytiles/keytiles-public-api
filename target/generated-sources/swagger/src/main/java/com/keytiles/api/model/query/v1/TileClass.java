...
import com.keytiles.api.model.common.types.v1.TileTypeEnum;
import com.keytiles.api.model.query.v1.TileGroupPathClass;
...
public class TileClass implements Serializable{
  ...
  // @Generator: becomes private - as non-nullable so we need to protect it with setter and null-check 
  private TileTypeEnum type = null;
  ...
  // @Generator: becomes private - as non-nullable so we need to protect it with setter and null-check 
  private List<TileGroupPathClass> tileGroupPaths = new ArrayList<>();
  ...
  public TileClass(@JsonProperty("id") String id, @JsonProperty("firstSeen") Integer firstSeen, @JsonProperty("lastSeen") Integer lastSeen, @JsonProperty("type") TileTypeEnum type) {
    ...
    if(firstSeen == null) {
      throw new IllegalArgumentException("'firstSeen' value can not be NULL");
    }
    if(lastSeen == null) {
      throw new IllegalArgumentException("'lastSeen' value can not be NULL");
    }
    if(type == null) {
  ...
  // @Generator: added to protect field 'firstSeen' against null-value assignment 
  @JsonProperty("firstSeen")
  ...
  // @Generator: added to protect field 'lastSeen' against null-value assignment 
  @JsonProperty("lastSeen")
  ...
  public List<TileGroupPathClass> getTileGroupPaths() {
    return tileGroupPaths;
  }  

  // @Generator: added to protect field 'tileGroupPaths' against null-value assignment 
  @JsonProperty("tileGroupPaths")
  public void setTileGroupPaths(List<TileGroupPathClass> tileGroupPaths) {
    if(tileGroupPaths == null) {
      throw new IllegalArgumentException("'tileGroupPaths' value can not be NULL");
    }
    this.tileGroupPaths = tileGroupPaths;
  }



  // @Generator: builder style helper method to add values to not-readonly array field
  public TileClass addTileGroupPathsItem(TileGroupPathClass tileGroupPathsItem) {
  ...
  public TileClass removeTileGroupPathsItem(TileGroupPathClass tileGroupPathsItem) {
    if (this.tileGroupPaths != null) {

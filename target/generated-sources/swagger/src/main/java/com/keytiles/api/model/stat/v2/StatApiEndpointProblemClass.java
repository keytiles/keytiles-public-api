...
import com.keytiles.api.model.stat.v2.StatApiEndpointErrorCodes;
import java.util.ArrayList;
import java.util.List;

import java.io.Serializable;

public class StatApiEndpointProblemClass extends ProblemBaseClass implements Serializable{
  ...
  public List<StatApiEndpointErrorCodes> errorCodes = new ArrayList<>();

  
  @JsonCreator
  public StatApiEndpointProblemClass(@JsonProperty("severity") SeverityEnum severity, @JsonProperty("message") String message) {
  ...
  public StatApiEndpointProblemClass addErrorCodesItem(StatApiEndpointErrorCodes errorCodesItem) {
  ...
  public StatApiEndpointProblemClass removeErrorCodesItem(StatApiEndpointErrorCodes errorCodesItem) {
    if (this.errorCodes != null) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StatApiEndpointProblemClass statApiEndpointProblemClass = (StatApiEndpointProblemClass) o;
    return Objects.equals(this.errorCodes, statApiEndpointProblemClass.errorCodes) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatApiEndpointProblemClass {\n");

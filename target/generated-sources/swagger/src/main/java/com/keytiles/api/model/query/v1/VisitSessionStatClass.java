...
import com.keytiles.api.model.query.v1.VisitSessionStatClassLengthInMinutesDistribution;
import com.keytiles.api.model.query.v1.VisitSessionStatClassNumberOfTotalActionsDistribution;
import java.util.ArrayList;
import java.util.List;

import java.io.Serializable;

public class VisitSessionStatClass implements Serializable{
  private static final long serialVersionUID = 1L;


  // @Generator: becomes private - as non-nullable so we need to protect it with setter and null-check 
  /**
   * The identified type of the visitor&#x27;s user agent as a grouping factor - we provide stats / each type
   *
   */
  ...
  // @Generator: becomes private - as non-nullable so we need to protect it with setter and null-check 
  private Integer countOfVisitSessions = null;

  // @Generator: becomes private - as non-nullable so we need to protect it with setter and null-check 
  private Integer avgVisitSessionLengthInSeconds = null;
  ...
  // @Generator: becomes private - as non-nullable so we need to protect it with setter and null-check 
  private List<VisitSessionStatClassLengthInMinutesDistribution> lengthInMinutesDistribution = new ArrayList<>();

  // @Generator: non-nullable property so Codegen applied a default empty array to it automatically because it is possible with this type 
  // @Generator: becomes private - as non-nullable so we need to protect it with setter and null-check 
  private List<VisitSessionStatClassNumberOfTotalActionsDistribution> numberOfTotalActionsDistribution = new ArrayList<>();
  ...
  public VisitSessionStatClass(@JsonProperty("userAgentType") UserAgentTypeEnum userAgentType, @JsonProperty("countOfVisitSessions") Integer countOfVisitSessions, @JsonProperty("avgVisitSessionLengthInSeconds") Integer avgVisitSessionLengthInSeconds) {
    ...
    if(countOfVisitSessions == null) {
      throw new IllegalArgumentException("'countOfVisitSessions' value can not be NULL");
    }
    if(avgVisitSessionLengthInSeconds == null) {
      throw new IllegalArgumentException("'avgVisitSessionLengthInSeconds' value can not be NULL");
    }
    this.userAgentType = userAgentType;
    this.countOfVisitSessions = countOfVisitSessions;
    this.avgVisitSessionLengthInSeconds = avgVisitSessionLengthInSeconds;
  }
  ...
  @JsonProperty("countOfVisitSessions")
  public Integer getCountOfVisitSessions() {
    return countOfVisitSessions;
  }  

  // @Generator: added to protect field 'countOfVisitSessions' against null-value assignment 
  @JsonProperty("countOfVisitSessions")
  public void setCountOfVisitSessions(Integer countOfVisitSessions) {
    if(countOfVisitSessions == null) {
      throw new IllegalArgumentException("'countOfVisitSessions' value can not be NULL");
    }
    this.countOfVisitSessions = countOfVisitSessions;
  ...
  @JsonProperty("avgVisitSessionLengthInSeconds")
  public Integer getAvgVisitSessionLengthInSeconds() {
    return avgVisitSessionLengthInSeconds;
  }  

  // @Generator: added to protect field 'avgVisitSessionLengthInSeconds' against null-value assignment 
  @JsonProperty("avgVisitSessionLengthInSeconds")
  public void setAvgVisitSessionLengthInSeconds(Integer avgVisitSessionLengthInSeconds) {
    if(avgVisitSessionLengthInSeconds == null) {
      throw new IllegalArgumentException("'avgVisitSessionLengthInSeconds' value can not be NULL");
    }
    this.avgVisitSessionLengthInSeconds = avgVisitSessionLengthInSeconds;
  ...
  @JsonProperty("lengthInMinutesDistribution")
  public List<VisitSessionStatClassLengthInMinutesDistribution> getLengthInMinutesDistribution() {
    return lengthInMinutesDistribution;
  }  

  // @Generator: added to protect field 'lengthInMinutesDistribution' against null-value assignment 
  @JsonProperty("lengthInMinutesDistribution")
  public void setLengthInMinutesDistribution(List<VisitSessionStatClassLengthInMinutesDistribution> lengthInMinutesDistribution) {
    if(lengthInMinutesDistribution == null) {
      throw new IllegalArgumentException("'lengthInMinutesDistribution' value can not be NULL");
    }
    this.lengthInMinutesDistribution = lengthInMinutesDistribution;
  }

  @JsonProperty("numberOfTotalActionsDistribution")
  public List<VisitSessionStatClassNumberOfTotalActionsDistribution> getNumberOfTotalActionsDistribution() {
    return numberOfTotalActionsDistribution;
  }  

  // @Generator: added to protect field 'numberOfTotalActionsDistribution' against null-value assignment 
  @JsonProperty("numberOfTotalActionsDistribution")
  public void setNumberOfTotalActionsDistribution(List<VisitSessionStatClassNumberOfTotalActionsDistribution> numberOfTotalActionsDistribution) {
    if(numberOfTotalActionsDistribution == null) {
      throw new IllegalArgumentException("'numberOfTotalActionsDistribution' value can not be NULL");
    }
    this.numberOfTotalActionsDistribution = numberOfTotalActionsDistribution;
  }



  // @Generator: builder style helper method to add values to not-readonly array field
  public VisitSessionStatClass addLengthInMinutesDistributionItem(VisitSessionStatClassLengthInMinutesDistribution lengthInMinutesDistributionItem) {
    if (this.lengthInMinutesDistribution == null) {
 		this.lengthInMinutesDistribution = new ArrayList<>();
    }
    this.lengthInMinutesDistribution.add(lengthInMinutesDistributionItem);
    return this;
  }

  // @Generator: builder style helper method to remove values from not-readonly array field
  public VisitSessionStatClass removeLengthInMinutesDistributionItem(VisitSessionStatClassLengthInMinutesDistribution lengthInMinutesDistributionItem) {
    if (this.lengthInMinutesDistribution != null) {
    	this.lengthInMinutesDistribution.remove(lengthInMinutesDistributionItem);
    }
    return this;
  }

  // @Generator: builder style helper method to add values to not-readonly array field
  public VisitSessionStatClass addNumberOfTotalActionsDistributionItem(VisitSessionStatClassNumberOfTotalActionsDistribution numberOfTotalActionsDistributionItem) {
    if (this.numberOfTotalActionsDistribution == null) {
 		this.numberOfTotalActionsDistribution = new ArrayList<>();
    }
    this.numberOfTotalActionsDistribution.add(numberOfTotalActionsDistributionItem);
    return this;
  }

  // @Generator: builder style helper method to remove values from not-readonly array field
  public VisitSessionStatClass removeNumberOfTotalActionsDistributionItem(VisitSessionStatClassNumberOfTotalActionsDistribution numberOfTotalActionsDistributionItem) {
    if (this.numberOfTotalActionsDistribution != null) {
    	this.numberOfTotalActionsDistribution.remove(numberOfTotalActionsDistributionItem);
    }
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VisitSessionStatClass visitSessionStatClass = (VisitSessionStatClass) o;
    return Objects.equals(this.userAgentType, visitSessionStatClass.userAgentType) &&
        Objects.equals(this.countOfVisitSessions, visitSessionStatClass.countOfVisitSessions) &&
        Objects.equals(this.avgVisitSessionLengthInSeconds, visitSessionStatClass.avgVisitSessionLengthInSeconds) &&
        Objects.equals(this.lengthInMinutesDistribution, visitSessionStatClass.lengthInMinutesDistribution) &&
        Objects.equals(this.numberOfTotalActionsDistribution, visitSessionStatClass.numberOfTotalActionsDistribution);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userAgentType, countOfVisitSessions, avgVisitSessionLengthInSeconds, lengthInMinutesDistribution, numberOfTotalActionsDistribution);
  }
  ...
  public String toString() {
    ...
    sb.append("class VisitSessionStatClass {\n");
    
    sb.append("    userAgentType: ").append(toIndentedString(userAgentType)).append("\n");
    sb.append("    countOfVisitSessions: ").append(toIndentedString(countOfVisitSessions)).append("\n");
    sb.append("    avgVisitSessionLengthInSeconds: ").append(toIndentedString(avgVisitSessionLengthInSeconds)).append("\n");
    sb.append("    lengthInMinutesDistribution: ").append(toIndentedString(lengthInMinutesDistribution)).append("\n");
    sb.append("    numberOfTotalActionsDistribution: ").append(toIndentedString(numberOfTotalActionsDistribution)).append("\n");
    sb.append("}");
    return sb.toString();
  }

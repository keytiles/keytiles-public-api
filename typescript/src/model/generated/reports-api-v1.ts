 ...
 */
export const postV1ReportsContainersActionsContainerIdReportSetupReportSetupIdStopUserNotifications = <TData = AxiosResponse<MessageResponseV3Class>>(
    containerId: string,
    reportSetupId: string,
    userReferenceListClass: UserReferenceListClass, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
      `/v1/reports/containers/actions/${containerId}/report-setup/${reportSetupId}/stop-user-notifications`,
      userReferenceListClass,options
    );
  }
 ...
 */
export const postV1ReportsContainersActionsContainerIdReportSetupReportSetupIdRestartUserNotifications = <TData = AxiosResponse<MessageResponseV3Class>>(
    containerId: string,
    reportSetupId: string,
    userReferenceListClass: UserReferenceListClass, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
      `/v1/reports/containers/actions/${containerId}/report-setup/${reportSetupId}/restart-user-notifications`,
      userReferenceListClass,options
    );
  }
 ...
 */
export const postV1ReportsContainersActionsContainerIdReportSetupReportSetupIdCheckUserNotificationStatus = <TData = AxiosResponse<UserReportSetupNotifBlacklistStatusClass>>(
    containerId: string,
    reportSetupId: string,
    userReferenceClass: UserReferenceClass, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
      `/v1/reports/containers/actions/${containerId}/report-setup/${reportSetupId}/check-user-notification-status`,
      userReferenceClass,options
    );
  }

...
/**
 * Extra meta-data (str -> str) of the mapping - might be optionally present.
 * @nullable
 */
export type MappingRecordClassMeta = {
    [key: string]: string;
} | null;
...
Only relevant if `mappingTypes` contains `eventType`.
  
In Keytiles there are certain event types (generated by goal-tracking) which do not necessarily belong to a Tile but more "global" only. By default these event types are not returned by the query. Unless you explicitly ask for them...
...
export type GetV2StatWebhitsContainerIdIdmappingsParams = {
    ...
    **Default value:** the current timestamp, so 'now' if you do not specify this parameter.
     ...
     */
    includeNotTileEventTypesAsWell?: IncludeNotTileEventTypesAsWellParameter;
};
